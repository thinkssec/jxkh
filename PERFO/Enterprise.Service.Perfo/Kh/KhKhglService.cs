...
namespace Enterprise.Service.Perfo.Kh
{
    ...
    public class KhKhglService
    {
        ...
        public string GetStatus(KhKhglModel model)
        {
        ...
        public void FinishKaohe(string khid)
        {
            ...
            sqls.Append("begin ");
            sqls.Append("update PERFO_KH_DLZBMX set WCZSDRQ=sysdate where KHID='" + khid + "' and WCZSDRQ is null;");
            sqls.Append("update PERFO_KH_UNLOCK set SDBZ='1',TJSJ=sysdate where KHID='" + khid + "' and SDBZ='0';");
            sqls.Append("update PERFO_KH_MESSAGE set DQZT='1',WCRQ=sysdate where KHID='" + khid + "' and DQZT='0';");
            sqls.Append("update PERFO_KH_KHGL set KHZT='1',GBSJ=sysdate where KHID='" + khid + "' and KHZT='0';");
            sqls.Append(" end;");
