...
var superTable = function (tableId) {
   ...
   //alert("this.sFHeader==="+this.sFHeader);                                          
    ...
    if (this.fixedCols > 0) {
        ...
        //alert("sFHeader====" + this.sFHeader.innerHTML); 
    ...
    //alert("sHeader====" + this.sHeader.innerHTML); 
    this.sHeaderTable = this.sHeader.getElementsByTagName("TABLE")[0];

    // fill the header dom framework 填充表头的内容
    ...
    if (this.fixedCols > 0) {
        ...
        //alert("headerRows==" + this.headerRows + "==rootDest.rows==" + rootDest.rows.length + "==rootSource.rows==" + rootSource.rows.length);
