        ...
        function download(v) {
            switch (v) {
                case '1'://机关部门
                    ...
                    break;
                case '2'://二级单位
                    window.open("/Module/Kh/FileDownload.aspx?url=" + encodeURI("/Component/Map/jietu/二级单位及领导班子考核操作流程说明.doc"));
                    break;
                case '3'://管理员
                    window.open("/Module/Kh/FileDownload.aspx?url=" + encodeURI("/Component/Map/jietu/绩效管理员操作手册.docx"));
                    break;
            }
        }
    </script>
...
<body>
    <div class="main-gridview">
        <table style="width: 100%; text-align: center;" id="Table2">
            ...
            <tr>
                ...
                <td><img alt="" src="/Resources/Images/ico/page_white_word.png" style="border:0;cursor:pointer;" onclick="download('1');"/></td>
            </tr>
            <tr>
                <td>2</td>
                <td><a onclick="download('2');">二级单位及领导班子考核</a></td>
                <td style="text-align:left;padding:4px;">二级单位及领导班子考核——用户操作及流程说明</td>
                <td><img alt="" src="/Resources/Images/ico/page_white_word.png" style="border:0;cursor:pointer;" onclick="download('2');"/></td>
            </tr>            
            <tr>
                <td>3</td>
                <td><a onclick="download('3');">绩效管理员操作手册</a></td>
                <td style="text-align:left;padding:4px;">绩效管理员——操作说明</td>
                <td><img alt="" src="/Resources/Images/ico/page_white_word.png" style="border:0;cursor:pointer;" onclick="download('3');"/></td>
            </tr> 
        </table>
    </div>
    <hr/>
    ...
    <div class="sitemap">
        ...
        <ul id="primaryNav" class="col6">
            ...
            <li><a href="#C1">二级单位及领导班子考核</a>
                <ul>
                    <li><a href="#C1-1">二级单位年度考核指标</a></li>
                    ...
                    <li><a href="#C1-10">二级单位考核结果审定</a></li>
                </ul>
            </li>
            ...
            <li><a href="#C3">查询统计</a>
                <ul>
                    <li><a href="#C3-1">二级单位考核结果</a></li>
                    <li><a href="#C3-2">二级单位领导班子考核结果</a></li>
                    <li><a href="#C3-3">二级单位考核明细表</a></li>
            ...
            <li><a href="#C4">考核管理</a>
                <ul>
                    ...
                    <li><a href="#C4-2">二级单位责任书指标</a></li>
                    <li><a href="#C4-3">机关部门责任书指标</a></li>
                    <li><a href="#C4-4">发起考核</a></li>
                    <li><a href="#C4-5">二级单位指标筛选</a></li>
    ...
    <div class="help-body">
        ...
        <%---------------- 二级单位及领导班子考核 ---------------------------%>
        <div class="article">
            <p class="main"><a name="C1">1. 二级单位及领导班子考核</a></p>
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                二级单位及领导班子考核模块是按照《华东石油局年度绩效考核实施细则》、《华东分公司年度绩效考核实施细则》、<br/>
                《华东工程公司年度绩效考核实施细则》开发的。它可以实现各二级单位及其领导班子的在线填报与得分汇总、统计等功能，<br/>
                同时还可方便的查询各单位的年度考核指标等信息。
            </p>
            <a name="C1-1" class="title" onclick="window.scrollTo(0,0);return false;">1.1 二级单位年度考核指标</a>
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块可以显示各二级单位和领导班子的年度考核指标明细；只有责任书下达后，各单位才能进行查询。
            </p>
        </div>
        <%--<div class="showimg">
            <table border="0">
        ...
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                二级单位的绩效责任指标下达，同时当考核正式开始后，可由职能部门和二级单位输入各指标的具体考核值。<br />
        ...
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块可由职能部门进行操作。二级单位的当期考核值设定后，还需要经过职能部门的审核才能正式生效。（注：由职能部门录入的目标值会自动生效）
            </p>
        </div>
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                当期考核目标值生效后，各二级单位就可以自行录入各指标的完成情况。其中包括：录入财务基础数据表，为关联指标提供基础数据；<br />
        ...
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                当二级单位的完成值正式提交后，可由相应的职能部门进行完成值的审核；点击‘计算指标得分’后，可以利用已配置好的计算关系式，<br />
        ...
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块可由职能部门进行操作，完成对各二级单位的约束性指标和加分指标的打分处理。
            </p>
        </div>
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块可由职能部门进行操作，负责对二级单位领导班子的约束性指标和加减分因素进行打分处理。
            </p>
        </div>
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块由二级单位进行操作，可将本单位的考核数据文件以附件的形式上传。
            </p>
        </div>
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块可由绩效考核办公室及绩效管理员进行操作，将各二级单位的考核结果进行最终的审定。<br />
                注：审定对象是针对已完成审核的指标。
            </p>
        </div>
        <div class="article">
            <a name="C1-10" class="title" onclick="window.scrollTo(0,0);return false;">1.10 二级单位考核结果审定</a>
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块可以实现对各二级单位及领导班子的考核成绩的统计与发布管理。可以分别统计二级单位、领导班子的指标得分情况，<br />
        ...
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                机关部门及负责人考核模块是按照《华东油气田机关部门考核实施细则》开发的。它可以实现对各机关部门及其负责人的上级打分、<br />
                同级打分和自评操作。打分结果实现自动汇总、统计，还可方便的查询各单位的年度考核指标等信息。
            </p>
        ...
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块可由机关部门的同级单位（各部门和二级单位）进行操作。各单位的打分根据权重不同再折算到每个部门的最终得分上。<br />
        ...
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块为机关作风建设类指标的打分汇总界面，可由绩效考核办公室和管理员进行操作。可分别对每个机关部门的“互评、二级单位、领导”<br />
        ...
        <div class="article">
            ...
            <a name="C3-1" class="title" onclick="window.scrollTo(0,0);return false;">3.1 二级单位考核结果</a>
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该页面用于显示所有已发布考核结果的各二级单位的考核成绩，并可以穿透查询二级单位的考核明细表。
            </p>
        </div>
        <div class="article">
            <a name="C3-2" class="title" onclick="window.scrollTo(0,0);return false;">3.2 二级单位领导班子考核结果</a>
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
        ...
        <div class="article">
            <a name="C3-3" class="title" onclick="window.scrollTo(0,0);return false;">3.3 二级单位考核明细表</a>
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该页面用于显示所有已发布考核结果的各二级单位的考核明细表。
            </p>
        </div>
        <div class="article">
            ...
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该页面用于显示所有已发布考核结果的各二级单位领导班子的考核明细表。
            </p>
        </div>
        <div class="article">
        ...
        <div class="article">
            ...
            <p>
                ...
                二级单位的责任书发起后可由负责的职能部门与二级单位共同制定年度绩效责任指标，制定完成后可由职能部门再直接下达给相应二级单位；
                机关部门的责任书发起后可由各部门自行组织制定年度绩效责任指标，制定完成后报部门领导审批，通过即可直接下达。
            </p>
        </div>
        <div class="article">
            <a name="C4-2" class="title" onclick="window.scrollTo(0,0);return false;">4.2 二级单位责任书指标</a>
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块可由二级单位和负责的职能部门共同操作，来制定本单位的绩效责任指标。该单位的责任指标根据考核采用的版本可从指标库中自动提取，
        ...
        <div class="article">
            <a name="C4-5" class="title" onclick="window.scrollTo(0,0);return false;">4.5 二级单位指标筛选</a>
            <p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                该模块由绩效考核办公室操作，用于筛选相应考核期下的各二级单位的考核指标。在该功能下还可以重新设置各指标的顺序号及权重与分值。
