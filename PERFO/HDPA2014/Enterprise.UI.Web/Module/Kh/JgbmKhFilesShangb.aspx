<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="JgbmKhFilesShangb.aspx.cs" Inherits="Enterprise.UI.Web.Kh.JgbmKhFilesShangb" %>
    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            ...
            <asp:GridView ID="GridView2" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                OnRowDataBound="GridView2_RowDataBound" OnRowCommand="GridView2_RowCommand" AllowPaging="false" DataKeyNames="KHID,JGBM">
                <Columns>
