...
namespace Enterprise.UI.Web.Kh
{
    ...
    ///机关部门负责人总部连带指标录入页面
    /// </summary>
    public partial class JgbmFzrJiajfLr : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            List<KhDfzbmxModel> dfzbList = dfzbmxSrv.GetListByKhidAndZhibiao(Ddl_Kaohe.SelectedValue,
                Ddl_Zhibiao.SelectedValue, WebKeys.KaoheType.部门负责人) as List<KhDfzbmxModel>;
        ...
        protected void BindDdl()
        {
            ...
            //指标
            var zhibiaoLst = dfzbmxSrv.GetListByKhidAndKhdx(Ddl_Kaohe.SelectedValue, WebKeys.KaoheType.部门负责人);
