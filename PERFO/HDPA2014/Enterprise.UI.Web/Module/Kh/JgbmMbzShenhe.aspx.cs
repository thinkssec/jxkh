...
namespace Enterprise.UI.Web.Kh
{
    ...
    ///机关部门目标值审核页面
    /// </summary>
    public partial class JgbmMbzShenhe : PageBase
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //指标性质 考核权重 3
                e.Row.Cells[3].Text = "〖" + (model.ZbsxModel.SXQZ.ToDecimal() * 100) + "%〗"; 
                //model.ZbsxModel.JxzrsZb.ZZBXZ + "<br/>〖" + (model.ZbsxModel.SXQZ.ToDecimal() * 100) + "%〗";
                //年度目标值 4
        ...
        protected void LnkBtn_Ins_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow gvr in GridView1.Rows)
            {
                ...
                {
                    model.MBZ = Request.Form[key].ToDecimal();
                }
                //说明 8
            ...
            if (isOk)
            {
                ...
                {
                    msgService.CloseMessage(userModel, Ddl_Kaohe.SelectedValue.ToInt(), "1111", Ddl_Danwei.SelectedValue);
                }
            }
