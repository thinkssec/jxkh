...
namespace Enterprise.UI.Web.Kh
{
    ...
    public partial class EjdwKhjgShending : PageBase
    {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else if (!string.IsNullOrEmpty(model.HBJFID))
                {
                    ...
                    if (xylzb != null)
                    {
                        ...
                        if (Pnl_Edit.Visible)
                        {
                            e.Row.Cells[4].Text = Utility.GetTextBox("Txt_" + 4 + "_" + (e.Row.RowIndex + 1), xylzb.KHDF, 0, 0,
                                "number", true, "", "width:80px;");
                        }
                        else
                        {
                    ...
                    if (gllzb != null)
                    {
                        ...
                        if (Pnl_Edit.Visible)
                        {
                            e.Row.Cells[6].Text = Utility.GetTextBox("Txt_" + 6 + "_" + (e.Row.RowIndex + 1), gllzb.KHDF, 0, 0,
                                "number", true, "", "width:80px;");
                        }
                        else
                        {
        ...
        protected void LnkBtn_Upd_Click(object sender, EventArgs e)
        {
            ...
            if (ejdwkhdfSrv.ExecuteSQL(sqlSB.ToString()))
            {
