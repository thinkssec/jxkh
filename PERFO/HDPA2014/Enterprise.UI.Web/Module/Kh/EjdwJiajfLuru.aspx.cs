...
namespace Enterprise.UI.Web.Kh
{
    ...
    ///二级单位加减分录入页面
    /// </summary>
    public partial class EjdwJiajfLuru : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            List<KhDfzbmxModel> dfzbList = dfzbmxSrv.GetListByKhidAndZhibiao(Ddl_Kaohe.SelectedValue,
                Ddl_Zhibiao.SelectedValue, WebKeys.KaoheType.二级单位) as List<KhDfzbmxModel>;
        ...
        protected void BindDdl()
        {
            ...
            //指标
            var zhibiaoLst = dfzbmxSrv.GetListByKhidAndKhdx(Ddl_Kaohe.SelectedValue, WebKeys.KaoheType.二级单位);
            zhibiaoLst = zhibiaoLst.DistinctBy(p => p.ZBBM).ToList();//一个指标只取一条
