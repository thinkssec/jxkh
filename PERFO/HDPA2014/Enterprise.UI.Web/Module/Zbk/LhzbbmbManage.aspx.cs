...
namespace Enterprise.UI.Web.Zbk
{
    ...
    public partial class LhzbbmbManage : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //绑定CLICK事件
            Txt_ZBDH.Attributes.Add("ondblclick", "showTsfhDiv();");
        }
        ...
        protected void BindDDL()
        {
            ...
            //目标值填报
            cb_mb1.DataSource = znbm_ejdw.Where(p => p.JGLX == "二级单位");
            ...
            cb_mb2.DataBind();
            //完成值填报
            cb_wc1.DataSource = znbm_ejdw.Where(p => p.JGLX == "二级单位");
            ...
            cb_dfz.Items.Insert(1, new ListItem("〖油气田领导〗", "YQTLD"));
