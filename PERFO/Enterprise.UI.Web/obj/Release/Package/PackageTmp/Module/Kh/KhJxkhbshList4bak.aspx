<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="KhJxkhbshList4.aspx.cs" Inherits="Enterprise.UI.Web.Kh.KhJxkhbshList4bak" %>
            ...
            <table class="GridViewStyle" cellspacing="0" rules="all" border="1" id="ProjectPH_GridView1" style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td nowrap align="center"><input type="checkbox" name="CB_DZB" 
                        ...
                        <%=mbjg.ContainsKey(m.ID)?(mbjg[m.ID]== "40" ? "" : "disabled"):"disabled" %>/>
                        <a href="/Module/KhX/Khzbpf.aspx?khid=<%=Khid %>&mbjgid=<%=dic3.ContainsKey(m.ID)?dic3[m.ID]:"" %>&back=KhJxkhbshList4bak&audit=1&dwdm=<%=dwdm %>" ><%=dic2[m.DZBID] %></a></td>
