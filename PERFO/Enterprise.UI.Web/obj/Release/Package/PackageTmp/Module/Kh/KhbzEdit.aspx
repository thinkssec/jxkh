<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="KhbzEdit.aspx.cs" Inherits="Enterprise.UI.Web.Kh.KhbzEdit" %>
    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            <div class="main-gridview-title">
                ...
                <asp:LinkButton ID="LinkButton2" runat="server" Text="提交" class="easyui-linkbutton" plain="true"
                    iconCls="icon-ok" OnClick="LnkBtn_Ok_Click"></asp:LinkButton>
            ...
            <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                ...
                <Columns>
                    ...
                    <%--<asp:TemplateField HeaderText="状态">
                        <ItemTemplate>
                            <%#Eval("STATUS")!=null?"":((int)Eval("STATUS")==1?"":"") %>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>--%>
                ...
                <div id="contents" class="ssec-form">
                    ...
                    <%--                    <asp:TemplateField HeaderText="考核项目名称">
                                        ...
                                        <asp:TemplateField HeaderText="部门名称">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="Cb_DZB" runat="server" Checked="true"/><%#Eval("JGMC") %>
                                            </ItemTemplate>
