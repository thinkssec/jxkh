<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="SjkhEdit.aspx.cs" Inherits="Enterprise.UI.Web.Kh.SjkhEdit" %>
        ...
        <div class="main-gridview">
            <div class="main-gridview-title">
                <asp:LinkButton ID="LnkBtn_Upd" runat="server" class="easyui-linkbutton" iconCls="icon-save"
                        OnClientClick="return checkForm()&&showLoading();" OnClick="LnkBtn_Upd_Click">保存</asp:LinkButton>
...
<%--                    <asp:TemplateField HeaderText="考核项目名称">
                ...
                max="100"  missingMessage="必须填写数字" Width="60" precision="4"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
