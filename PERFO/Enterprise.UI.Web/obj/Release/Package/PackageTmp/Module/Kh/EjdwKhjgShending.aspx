    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            <div class="main-gridview-title">
                ...
                &nbsp;&nbsp;
                <asp:LinkButton ID="LnkBtn_Calculate" runat="server" Text="1统计基层单位得分" class="easyui-linkbutton" plain="true"
            ...
            <div id="tt" class="easyui-tabs" style="width: auto;">
                <div title="基层单位" data-options="iconCls:'icon-yunxing'" style="padding: 4px; overflow-y: hidden;">
                    <div class="main-gridview">
                        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="专项考核标准分">
                                    <ItemTemplate>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="专项考核得分">
                                    <ItemTemplate>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                    ...
                    <div class="main-gridview">
                        <asp:GridView ID="GridView2" Width="100%" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="兑现倍数" Visible="false">
                                    <ItemTemplate>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
            ...
            <asp:Panel ID="Pnl_Edit" runat="server" Visible="false">
                <div class="btn-bgcolor">
                    发布选择：<asp:CheckBoxList ID="ChkBox_FBLX" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="基层单位考核结果" Value="EJDW" Selected="True"></asp:ListItem>
