<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KaoheBumenIndexNew.aspx.cs"  ValidateRequest="false" 
    Inherits="Enterprise.UI.Web.Module.KaoheBumenIndexNew" %>
    ...
    <div data-options="region:'center'">
        ...
        <div id="p1" class="easyui-panel" title="我的待办箱【<%=MessageCount %>】"
            ...
            <div class="main-gridview">
                ...
                <br />
                <%-- 需机关部门审核指标的说明 --%>
                <table style="width: 100%; text-align: center;" id="Table6">
                    <%=GetEjdwKaoheInfo() %>
                </table>
            </div>
        </div>
                    ...
                    <div class="main-gridview">
                        <table style="width: 100%; text-align: center;" id="Table3">
                                    ...
                                    <asp:GridView ID="GridView_Kaohe" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="考核状态">
                                                <ItemTemplate>
                                                    <%#Eval("LXID").ToRequestString()=="LX2014A"?"基层单位考核":"机关部门考核" %>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                           <%--                 <asp:BoundField DataField="KHND" HeaderText="考核年度">
                                            ...
                                            <asp:TemplateField HeaderText="考核状态">
                                                <ItemTemplate>
                                                    <%#Eval("KHZT").ToRequestString()=="1"?"结束":"进行中" %>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                        </Columns>
