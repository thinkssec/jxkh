<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="Enterprise.UI.Web.Sys.UserPermissionSet" CodeBehind="UserPermissionSet.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="main">
                <div class="select">
                    用户账号：<asp:DropDownList ID="Ddl_LoginId" runat="server" AutoPostBack="True"
                        OnSelectedIndexChanged="Ddl_LoginId_SelectedIndexChanged">
                    </asp:DropDownList>
                </div>
                <div>
                    <table>
