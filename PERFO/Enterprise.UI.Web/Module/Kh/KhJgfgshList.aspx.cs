...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class KhJgfgshList : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            string sql = @"select d.zbmc key1, d.zbmc key2,d.fzbm jgbm,
                        rank() over( partition by d.zbmc order by nvl(c.status,999),c.id) px, a.khid key3, c.*
                             ...
                             where a.khid = b.khid
                               ...
                               and b.dzbid = d.dzbid
                               and d.fzbm=f.jgbm
                               and f.loginid='" +this.userModel.LOGINID+
                               "' and a.khid=" + khId;
        ...
        {
            Response.Redirect("~/Module/Kh/JgfgKhdfList.aspx" , true);
        }
        ...
        protected void Btn_Ok_Click(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            if (mbjgSrv.Update50(khId,this.userModel.LOGINID)) {            
        ...
        protected void Btn_Ok1_Click(object sender, EventArgs e)
        {
            ...
            //    }
            //}
            if (mbjgSrv.Update42(khId, this.userModel.LOGINID)) 
            {
                //SysUserModel s = usrv.GetList().Where(p => p.DUTY == "分管领导").FirstOrDefault();
                //if (s != null)
                //{
