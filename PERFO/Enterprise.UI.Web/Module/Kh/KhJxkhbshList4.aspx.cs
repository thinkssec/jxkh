...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class KhJxkhbshList4 : PageBase
    {
        ...
        protected string dwdm = (string)Utility.sink("DWDM", Utility.MethodType.Get, 0, 0, Utility.DataType.Str);
        public string audit = "";
        bool haveDel = false;
        #region 权限检查
        ...
        protected void BindGrid()
        {
            ...
            string sql = @"select d.zbmc key1, e.jgmc key2, a.khid key3, c.*
                             ...
                             where a.khid = b.khid
                               ...
                               and b.dzbid = d.dzbid
                               and c.jgbm = e.jgbm
                               and d.fzbm = '" + dwdm + "' and a.khid=" + khId ;
        ...
        protected void Btn_Ok_Click(object sender, EventArgs e)
        {
            ...
            //SysUserModel s = usrv.GetList().Where(p => p.DUTY == "职能部门负责人" && p.JGBM == this.userModel.Bmjg.JGBM).FirstOrDefault();
            //if (s != null)
            //{
            //    user.Add(s.LOGINID);
            //}
            //if (user.Count > 0)
            //{
            //    string fileUrl = "Module/Kh/KhJgbmldshList2.asp";
            ...
            //        "部门领导审核", "需要您审核【" + khm.KHMC + "】!",
            //        "/Module/Kh/KhJgbmldshList2.aspx",
