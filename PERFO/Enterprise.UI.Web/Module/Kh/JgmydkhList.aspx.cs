...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class JgmydkhList : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            //}
            string sql = @"select a.id bbmc,t.*
                          from PERFO_KH_KHGL t, PERFO_KHS_KHDZB a, PERFO_KHS_DZB b
                         where a.khid = t.khid and t.lxid='LX2014B'
                           and t.khzt >= 2 and a.dzbid=b.dzbid and b.zbmc='机关服务满意度指标'";
