...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class KhJcdwdfList2 : PageBase
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (!string.IsNullOrEmpty(model.STATUS) && model.STATUS != "32" && model.STATUS != "42" && model.STATUS != "52")
                    ib.Enabled = false;
        ...
        {
            Response.Redirect("~/Module/Kh/KhJcdwdfList.aspx", true);
        }
        ...
        protected void Btn_Ok_Click(object sender, EventArgs e)
        {
            ...
            if (user.Count > 0)
            {
                string fileUrl = "Module/Kh/KhJgbmldshList.asp";
                ...
                msgService.SendMsgToUers(user, 1, khm.KHID + "",
                    "机关部门领导审核", "需要您审核【" + khm.KHMC + "】!",
                    "/Module/Kh/KhJgbmldshList.aspx",
