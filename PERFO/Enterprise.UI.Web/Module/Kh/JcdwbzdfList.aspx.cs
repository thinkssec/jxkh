...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class JcdwbzdfList : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            GridView1.DataSource = list.Where(p => p.LXID == "LX2014C"&&(p.FQBM==this.userModel.JGBM||p.FQBM==this.userModel.Bmjg.PID)).OrderByDescending(o => o.KHID).ToList();
            GridView1.DataBind();
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //e.Row.Cells[7].Text = khglSrv.GetStatus(model);
