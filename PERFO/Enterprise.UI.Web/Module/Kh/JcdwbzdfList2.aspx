<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="JcdwbzdfList2.aspx.cs" Inherits="Enterprise.UI.Web.Kh.JcdwbzdfList2" %>
    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            <div class="main-gridview-title">
                ...
                <%--<asp:LinkButton ID="Btn_Ok" runat="server" Text="提交部门领导审核" class="easyui-linkbutton" plain="true"
            ...
            <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="单位名称">
                        <ItemTemplate>
                            <%--<asp:CheckBox ID="Cb_ID" runat="server" />--%><a href="/Module/KhX/Khzbpf.aspx?khid=<%#Eval("KEY3") %>&mbjgid=<%#Eval("ID") %>&back=JcdwbzdfList2&audit=1" ><%#Eval("KEY2")%></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
