<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="KhJgfgshList.aspx.cs" Inherits="Enterprise.UI.Web.Kh.KhJgfgshList" %>
    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            <div class="main-gridview-title">
                ...
                <asp:LinkButton ID="Btn_Ok" runat="server" Text="提交绩效考核办汇总" class="easyui-linkbutton" plain="true"
            ...
            <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="单位名称">
                        <ItemTemplate>
                            <%--<asp:CheckBox ID="Cb_ID" runat="server" />--%><a href="/Module/Kh/KhJxkhbshList4.aspx?KHID=<%#Eval("KEY3") %>&DWDM=<%#Eval("JGBM") %>" ><%#Eval("KEY2")%></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
