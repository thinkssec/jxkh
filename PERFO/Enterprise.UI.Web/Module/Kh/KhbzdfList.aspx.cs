...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class KhbzdfList : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            GridView1.DataSource = list.Where(p => p.LXID == "LX2014C" && (p.KHZT == "2" || p.KHZT == "3") && (p.FQBM == this.userModel.JGBM || p.FQBM == this.userModel.Bmjg.PID)).OrderByDescending(o => o.KHID).ToList();
            GridView1.DataBind();
        }
