...
namespace Enterprise.UI.Web.Kh
{
    ...
    ///二级单位考核结果明细页面
    /// </summary>
    public partial class CxtjEjdwKhjgMX : PageBase
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (supperM.GetType().IsAssignableFrom(typeof(KhDlzbmxModel)))
                {
                    ...
                    //指标名称 2
                    e.Row.Cells[2].Text = ((model.ZbsxModel.JxzrsZb.ZZBXZ == "辅助指标") ? model.LhzbModel.GradeSymbol + model.LhzbModel.Zbxx.ZBMC : model.LhzbModel.Zbxx.ZBMC);
                    //指标性质 考核权重 3
                ...
                else if (supperM.GetType().IsAssignableFrom(typeof(KhDfzbmxModel)))
                {
                    ...
                    //指标名称 2
                    e.Row.Cells[2].Text = dfModel.DfzbModel.Zbxx.ZBMC;
