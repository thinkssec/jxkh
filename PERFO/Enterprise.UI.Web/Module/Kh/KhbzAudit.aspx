<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="KhbzAudit.aspx.cs" Inherits="Enterprise.UI.Web.Kh.KhbzAudit" %>
    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            <div class="main-gridview-title">
                ...
                &nbsp;&nbsp;
                <asp:LinkButton ID="Btn_Ok" runat="server" Text="下达考核标准" class="easyui-linkbutton" plain="true"
                    iconCls="icon-ok" OnClick="Btn_Ok_Click" OnClientClick="return ss();"></asp:LinkButton>
            ...
            <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="考核名称">
                        <ItemTemplate>
                           <asp:CheckBox ID="Cb_KHID" runat="server" /> <%#Eval("KHMC") %>
                        </ItemTemplate>
