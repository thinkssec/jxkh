<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="JcdwKfList2.aspx.cs" Inherits="Enterprise.UI.Web.Kh.JcdwKfList2" %>
        ...
        <div class="main-gridview">
            ...
            <table class="GridViewStyle" cellspacing="0" rules="all" border="1" id="ProjectPH_GridView1" style="width:100%;border-collapse:collapse;">
                <tr class="GridViewHeaderStyle">
                    ...
                    <th colspan="<%=jgL.Count() %>" >基层单位扣分明细</th>
                 </tr>
                <tr class="GridViewHeaderStyle">
                    <%
                ...
                <tr>
                    ...
                    <%
                        ...
                        foreach(var n in jgL){
                            %>
                            <td  align="<%=dic.ContainsKey(m.ID+n.JGBM)?"left":"center" %>"  style="width:100px">
                                <span id="pf_<%=i %>_<%=j %>"  style="font-size:11px;<%=dic.ContainsKey(m.ID+n.JGBM)?"color:red":"" %>"><%=dic.ContainsKey(m.ID+n.JGBM)?dic[m.ID+n.JGBM]+"":"无扣分项" %></span>
                            </td>
                            <%--<td nowrap align="center">
