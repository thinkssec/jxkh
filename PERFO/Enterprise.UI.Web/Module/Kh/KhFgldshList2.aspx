<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="KhFgldshList2.aspx.cs" Inherits="Enterprise.UI.Web.Kh.KhFgldshList2" %>
    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            ...
            <div class="btn-bgcolor">
                ...
                <asp:LinkButton ID="Btn_Ok" runat="server" Text="审核通过" class="easyui-linkbutton" plain="true"
                    iconCls="icon-ok" OnClick="Btn_Ok1_Click"></asp:LinkButton>
                &nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton3" runat="server" Text="退回" class="easyui-linkbutton" plain="true"
                    iconCls="icon-cancel" OnClick="Btn_Ok2_Click"></asp:LinkButton>
                &nbsp;&nbsp;
