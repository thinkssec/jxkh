<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="ZhibiaoJgbmSXEdit.aspx.cs" Inherits="Enterprise.UI.Web.Kh.ZhibiaoJgbmSXEdit" %>
    ...
    <script type="text/javascript">
        ...
        function Heji(txtObj) {
            try {
                ...
                var txtObjs = $("input[name^='TxtLhzb5_']");
                ...
                if (tdObj)
                    tdObj.innerHTML = "<font color='Red'>" + hjz + "</font>";
            }
            catch (e) {
                alert(e);
            }
