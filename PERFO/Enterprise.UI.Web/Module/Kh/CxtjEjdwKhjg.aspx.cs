...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 二级单位考核结果查询页面
    /// </summary>
    public partial class CxtjEjdwKhjg : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            var dataList = EjdwkhdfList.Where(p => p.KHLX == ((int)WebKeys.KaoheType.二级单位).ToString() || p.ISHBJF == "1")
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else if (!string.IsNullOrEmpty(model.HBJFID))
                {
                    ...
                    e.Row.Cells[1].Text = (model.DWPM != null) ? model.DWPM.ToString() : (e.Row.RowIndex + 1).ToString();
                    //单位名称2
                    e.Row.Cells[2].Text = string.Format("<a href=\"/M.K.CxtjEjdwMX?KH={0}&BM={1}\">{2}</a>", model.KHID, model.JGBM, model.JGMC);
                    //按类型提取数据
                    decimal dlzbZhdf = 0M;
                    ...
                    {
                        //效益类标准分3
                        e.Row.Cells[3].Text = xylzb.KHBZF.ToRequestString();
                        //效益类得分4
                        e.Row.Cells[4].Text = xylzb.KHDF.ToRequestString();
                    ...
                    {
                        //管理类 标准分5
                        e.Row.Cells[5].Text = gllzb.KHBZF.ToRequestString();
                        //管理类得分6
                        e.Row.Cells[6].Text = gllzb.KHDF.ToRequestString();
