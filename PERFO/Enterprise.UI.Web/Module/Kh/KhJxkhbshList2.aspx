<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="KhJxkhbshList2.aspx.cs" Inherits="Enterprise.UI.Web.Kh.KhJxkhbshList2" %>
    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            <div class="main-gridview-title">
                ...
                <asp:LinkButton ID="Btn_Ok" runat="server" Text="提交分管领导审核" class="easyui-linkbutton" plain="true"
                    iconCls="icon-ok" OnClick="Btn_Ok_Click" OnClientClick="getCb();"></asp:LinkButton>
                &nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton2" runat="server" Text="重新审核" class="easyui-linkbutton" plain="true"
                    iconCls="icon-cancel" OnClick="Btn_Ok1_Click" OnClientClick="getCb();"></asp:LinkButton>
                &nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton3" runat="server" Text="关闭考核" class="easyui-linkbutton" plain="true"
                    iconCls="icon-ok" OnClick="Btn_Ok2_Click" OnClientClick="getCb();"></asp:LinkButton>
                &nbsp;&nbsp;
            ...
            <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="单位名称">
                        <ItemTemplate>
                            <%--<asp:CheckBox ID="Cb_ID" runat="server" />--%><a href="/Module/Kh/KhJxkhbshList3.aspx?KHID=<%#Eval("KEY3") %>&DWDM=<%#Eval("JGBM") %>" ><%#Eval("KEY2")%></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:TemplateField>
                    <asp:BoundField DataField="KEY1" HeaderText="考核项目" Visible="false">
                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="得分"  Visible="false">
                        <ItemTemplate>
