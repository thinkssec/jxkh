...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class KhbzbzList2 : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            if (m1 != null) { 
                ...
                if (m2 != null && m3 != null) {
                    title = "    <span style='color:black'>" + m2.KHMC + "</span>&nbsp;&nbsp;&nbsp;&nbsp;" + m2.Kind.LXMC + "&nbsp;&nbsp;&nbsp;&nbsp;<span style='color:red'>" + m3.ZBMC + "</span>&nbsp;&nbsp;&nbsp;&nbsp;";
                }
            }
            Lb_Title.Text = title;
        ...
        protected void LnkBtn_Cancel_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Module/Kh/KhbzbzList.aspx", true);
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            KhsKhdzbService khdzbSrv = new KhsKhdzbService();
            KhsKhdzbModel khdzbM=khdzbSrv.GetList().Where(p=>p.ID==Id).FirstOrDefault();
            KhKhglModel khglM=khglSrv.GetList().Where(p=>p.KHID==khdzbM.KHID).FirstOrDefault();
            bmList = bmSrv.GetList().Where(p => p.JGLX == "四级单位" && p.SFKH == "4" && p.PID == khglM.FQBM).OrderBy(o => o.JGLX).ToList();
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "bianji":
                    ...
                    break;
                case "khnr":
                    Response.Redirect("~/Module/KhX/KhZbLr.aspx?mbid=" + model.ID + "&bm=" + this.userModel.Bmjg.JGBM + "&id=" + model.KHDZBID + "&back=KhbzbzList2", true);
                    break;
                default:
                    break;
            }
