<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="JgbmFzrJiajfLr.aspx.cs" Inherits="Enterprise.UI.Web.Kh.JgbmFzrJiajfLr" %>
    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            <div class="main-gridview-title">
                ...
                &nbsp;&nbsp;
                指标项：<Ent:SSECDropDownList ID="Ddl_Zhibiao" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Ddl_Zhibiao_SelectedIndexChanged" >
                </Ent:SSECDropDownList>
                &nbsp;&nbsp;
            ...
            <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="否决项" Visible="false">
                        <ItemTemplate>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
