<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="XsEdit.aspx.cs" Inherits="Enterprise.UI.Web.Kh.XsEdit" %>
            ...
            try {
                ...
                $("input[id^='Txtx_']").each(function (i) {
                    ...
                    if (attr == "jiguan") {
                        ...
                        var col = $("#Txt_" + deptid + "_" + attr).val();
                        var hj = col * 0;
                        if (deptid == "104") hj = col * 0.07;
                        else if (deptid == "122") hj = col * 0.05;
                        if (deptid == "153") hj = col * 0.03;
                        $(this).val(hj.toFixed(3));
                    }
        ...
        <div class="main-gridview">
            ...
            <table class="GridViewStyle" cellspacing="0" rules="all" border="1" id="ProjectPH_GridView1" style="width:100%;border-collapse:collapse;">
                ...
                <tr class="GridViewRowStyle" style="background-color:c">
                    ...
                    <td align="center" nowrap>
                        ...
                        <asp:TextBox ID="Txt_2_jiguan" ClientIDMode="Static" runat="server" class="easyui-numberbox" min="0"
                                    max="10000" precision="0" missingMessage="必须填写数字" Width="40" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_2_gonglishu" ClientIDMode="Static" runat="server" class="easyui-numberbox"  min="0"
                                    max="99999999" precision="1" missingMessage="必须填写数字" Width="40" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_2_dimao" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">平原</asp:ListItem>
                            <asp:ListItem Value="0.01">水网</asp:ListItem>
                            <asp:ListItem Value="0.02">山区</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_2_chengzhenhua" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">落后</asp:ListItem>
                            <asp:ListItem Value="0.01">中等</asp:ListItem>
                            <asp:ListItem Value="0.02">发达</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td align="center" nowrap>
                    ...
                    <td align="center" nowrap>-</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_2_bz" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:c">
                    <td align="center" nowrap>单项增加</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_jiguan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_yunxingjizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_rebeijizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_lengbeijizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_2_tj1" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true" ></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_daxingshuqizhan" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_xiaoxingshuqizhan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_2_tj2" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_gonglishu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_dimao" ClientIDMode="Static" runat="server"   Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_chengzhenhua" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_2_weixiudui" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_2_tj4" runat="server"  ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_2_zjxs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_2_xs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_2_bzx" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:#eeeeee">
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_17_dimao" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">平原</asp:ListItem>
                            <asp:ListItem Value="0.01">水网</asp:ListItem>
                            <asp:ListItem Value="0.02">山区</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_17_chengzhenhua" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">落后</asp:ListItem>
                            <asp:ListItem Value="0.01">中等</asp:ListItem>
                            <asp:ListItem Value="0.02">发达</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>-</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_17_bz" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:#eeeeee">
                    <td align="center" nowrap>单项增加</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_jiguan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_yunxingjizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_rebeijizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_lengbeijizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_17_tj1" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_daxingshuqizhan" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_xiaoxingshuqizhan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_17_tj2" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_gonglishu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_dimao" ClientIDMode="Static" runat="server"   Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_chengzhenhua" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_17_weixiudui" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_17_tj4" runat="server"  ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_17_zjxs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_17_xs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_17_bzx" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:c">
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_40_dimao" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">平原</asp:ListItem>
                            <asp:ListItem Value="0.01">水网</asp:ListItem>
                            <asp:ListItem Value="0.02">山区</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_40_chengzhenhua" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">落后</asp:ListItem>
                            <asp:ListItem Value="0.01">中等</asp:ListItem>
                            <asp:ListItem Value="0.02">发达</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>-</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_40_bz" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:c">
                    <td align="center" nowrap>单项增加</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_jiguan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_yunxingjizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_rebeijizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_lengbeijizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_40_tj1" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_daxingshuqizhan" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_xiaoxingshuqizhan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_40_tj2" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_gonglishu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_dimao" ClientIDMode="Static" runat="server"   Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_chengzhenhua" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_40_weixiudui" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_40_tj4" runat="server"  ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_40_zjxs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_40_xs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_40_bzx" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:#eeeeee">
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_63_dimao" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">平原</asp:ListItem>
                            <asp:ListItem Value="0.01">水网</asp:ListItem>
                            <asp:ListItem Value="0.02">山区</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_63_chengzhenhua" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">落后</asp:ListItem>
                            <asp:ListItem Value="0.01">中等</asp:ListItem>
                            <asp:ListItem Value="0.02">发达</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>-</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_63_bz" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:#eeeeee">
                    <td align="center" nowrap>单项增加</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_63_jiguan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap style="background-color:gray">
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_63_daxingshuqizhan" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_63_xiaoxingshuqizhan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_63_tj2" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_63_gonglishu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_63_dimao" ClientIDMode="Static" runat="server"   Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_63_chengzhenhua" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap >
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_63_weixiudui" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_63_tj4" runat="server"  ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_63_zjxs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_63_xs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_63_bzx" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:c">
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_164_dimao" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">平原</asp:ListItem>
                            <asp:ListItem Value="0.01">水网</asp:ListItem>
                            <asp:ListItem Value="0.02">山区</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_164_chengzhenhua" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">落后</asp:ListItem>
                            <asp:ListItem Value="0.01">中等</asp:ListItem>
                            <asp:ListItem Value="0.02">发达</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>-</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_164_bz" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:c">
                    <td align="center" nowrap>单项增加</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_164_jiguan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap style="background-color:gray">
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_164_daxingshuqizhan" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_164_xiaoxingshuqizhan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_164_tj2" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_164_gonglishu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_164_dimao" ClientIDMode="Static" runat="server"   Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_164_chengzhenhua" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap >
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_164_weixiudui" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_164_tj4" runat="server"  ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_164_zjxs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_164_xs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_164_bzx" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:#eeeeee">
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_82_dimao" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">平原</asp:ListItem>
                            <asp:ListItem Value="0.01">水网</asp:ListItem>
                            <asp:ListItem Value="0.02">山区</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>
                        <asp:DropDownList ID="Ddl_82_chengzhenhua" runat="server" ClientIDMode="Static" BackColor="LawnGreen">
                            <asp:ListItem Value="0">落后</asp:ListItem>
                            <asp:ListItem Value="0.01">中等</asp:ListItem>
                            <asp:ListItem Value="0.02">发达</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td align="center" nowrap>-</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_82_bz" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:#eeeeee">
                    <td align="center" nowrap>单项增加</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_82_jiguan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap style="background-color:gray">
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_82_daxingshuqizhan" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_82_xiaoxingshuqizhan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_82_tj2" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_82_gonglishu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_82_dimao" ClientIDMode="Static" runat="server"   Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_82_chengzhenhua" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_82_weixiudui" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_82_tj4" runat="server"  ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_82_zjxs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_82_xs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_82_bzx" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:c">
                    ...
                    <td align="center" nowrap>-</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_104_bz" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:c">
                    <td align="center" nowrap>单项增加</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_104_jiguan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap style="background-color:gray">
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_104_weixiudui" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_104_tj4" runat="server"  ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_104_zjxs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_104_xs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_104_bzx" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:#eeeeee">
                    ...
                    <td align="center" nowrap>-</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_122_bz" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:#eeeeee">
                    <td align="center" nowrap>单项增加</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_122_jiguan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap style="background-color:gray">
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_122_weixiudui" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_122_tj4" runat="server"  ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_122_zjxs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_122_xs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_122_bzx" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:c">
                    ...
                    <td align="center" nowrap>-</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_153_bz" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
                <tr class="GridViewRowStyle" style="background-color:c">
                    <td align="center" nowrap>单项增加</td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_153_jiguan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_153_yunxingjizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_153_rebeijizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_153_lengbeijizu" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_153_tj1" runat="server" ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_153_daxingshuqizhan" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_153_xiaoxingshuqizhan" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                    ...
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txtx_153_weixiudui" ClientIDMode="Static" runat="server" Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:Label ID="Lb_153_tj4" runat="server"  ClientIDMode="Static" Text="" ForeColor="Black" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_153_zjxs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_153_xs" ClientIDMode="Static" runat="server"  Width="40" ReadOnly="true" BackColor="IndianRed"></asp:TextBox>
                    </td>
                    <td align="center" nowrap>
                        <asp:TextBox ID="Txt_153_bzx" runat="server" class="easyui-validatebox" Width="60px" BackColor="LawnGreen"></asp:TextBox>
                    </td>
                </tr>
            </table>
