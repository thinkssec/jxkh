<%@ Page Title="" Language="C#" MasterPageFile="../Project.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="KhxfList.aspx.cs" Inherits="Enterprise.UI.Web.Kh.KhxfList" %>
...
<%--                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="Txt_KHJD" runat="server" Width="30" class="easyui-numberbox" required="true" precision="0"></asp:TextBox>
                            </td>
                        </tr>
                    ...
                    <%--                    <asp:TemplateField HeaderText="考核项目名称">
                                        ...
                                        <asp:TemplateField HeaderText="考核项目">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="Cb_DZB" runat="server" Checked="true"/><%#Eval("ZBMC") %>
                                            </ItemTemplate>
                                    ...
                                    max="999"  missingMessage="必须填写数字" Width="30" precision="1" Text="<%#(Container.DataItemIndex + 1) %>"></asp:TextBox>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                        </asp:TemplateField>
                                    </Columns>
                    ...
                    <asp:LinkButton ID="LnkBtn_Ok" runat="server" class="easyui-linkbutton" iconCls="icon-ok"
                        OnClientClick="return checkForm();" OnClick="LnkBtn_Ok_Click">下发</asp:LinkButton>
