    ...
    <div data-options="region:'center'">
        ...
        <div class="main-gridview">
            ...
            <div id="tt" class="easyui-tabs" style="width: auto;">
                <div title="基层单位考核指标" data-options="iconCls:'icon-yunxing'" style="padding: 4px; overflow-y: hidden;">
                    <div class="main-gridview">
            ...
            <asp:Panel ID="Pnl_Edit" runat="server" Visible="false">
                <div style="background: #c6f8f8; padding: 5px; width: auto;">
                    <asp:LinkButton ID="LnkBtn_Ins" runat="server" class="easyui-linkbutton" iconCls="icon-save"
                        OnClientClick="return checkForm()&&showLoading();" OnClick="LnkBtn_Ins_Click">保存数据</asp:LinkButton>
                    <asp:LinkButton ID="LnkBtn_Upd" runat="server" class="easyui-linkbutton" iconCls="icon-ok"
                        OnClientClick="return checkForm()&&showLoading();" OnClick="LnkBtn_Upd_Click">审定完成</asp:LinkButton>
