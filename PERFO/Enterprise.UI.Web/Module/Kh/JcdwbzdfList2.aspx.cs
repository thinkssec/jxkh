...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class JcdwbzdfList2 : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            string sql = @"select d.zbmc key1, e.jgmc key2, a.khid key3, c.*
                             ...
                             where a.khid = b.khid
                               ...
                               and b.dzbid = d.dzbid
                               and c.jgbm = e.jgbm
                               and c.jgbm = "+this.userModel.JGBM+
                               " and (a.fqbm = "+this.userModel.JGBM+" or a.fqbm="+this.userModel.Bmjg.PID+") and a.khid="+khId;
        ...
        {
            Response.Redirect("~/Module/Kh/JcdwbzdfList.aspx", true);
        }
