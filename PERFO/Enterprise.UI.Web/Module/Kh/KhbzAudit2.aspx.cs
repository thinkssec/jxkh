...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class KhbzAudit2 : PageBase
    {
        ...
        protected void LnkBtn_Cancel_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Module/Kh/KhbzAudit.aspx", true);
        }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "bianji":
                    ...
                    break;
                case "khnr":
                    Response.Redirect("~/Module/KhX/KhZbLr2.aspx?mbid=" + model.ID + "&bm=" + this.userModel.Bmjg.JGBM + "&id=" + model.KHDZBID, true);
                    break; 
                default:
                    break;
            }
        ...
        protected void LnkBtn_Yes_Click(object sender, EventArgs e)
        {
            //string url = string.Format("BB={0}&BM={1}&ND={2}", Bbmc, Jgbm, Sznd);
            KhsKhdzbModel m1 = null;
            KhsKhdzbService s1 = new KhsKhdzbService();
        ...
        protected void LnkBtn_No_Click(object sender, EventArgs e)
        {
            //string url = string.Format("BB={0}&BM={1}&ND={2}", Bbmc, Jgbm, Sznd);
            KhsKhdzbModel m1 = null;
            KhsKhdzbService s1 = new KhsKhdzbService();
