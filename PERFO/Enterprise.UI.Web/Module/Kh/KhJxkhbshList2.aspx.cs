...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class KhJxkhbshList2 : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            string sql = @"select d.zbmc key1, e.jgmc key2,rank() over( partition by e.jgmc order by b.id) px, a.khid key3, c.*
        ...
        {
            Response.Redirect("~/Module/Kh/KhJxkhbshList.aspx", true);
        }
