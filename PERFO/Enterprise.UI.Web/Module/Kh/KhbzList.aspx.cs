...
namespace Enterprise.UI.Web.Kh
{
    ...
    /// 发起考核页面
    /// </summary>
    public partial class KhbzList : PageBase
    {
        ...
        protected void BindGrid() 
        {
            ...
            KhKhglService khglSrv = new KhKhglService();
            //string sql = "select a.* from perfo_kh_khgl a,PERFO_KHS_KHDZB b ,PERFO_KHS_DZB c where a.khzt='-1' and  a.khid=b.khid and b.dzbid=c.dzbid and c.fzbm=" + this.userModel.JGBM + " and c.zbmc not in ('工作要点','上级考核','机关服务满意度指标')";
            string sql = "select a.* from perfo_kh_khgl a  where a.khzt='-1'";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string sql = "select a.* from PERFO_KHS_DZB a ,PERFO_KHS_KHDZB b where a.dzbid=b.dzbid and b.khid="+model.KHID+" and a.fzbm="+this.userModel.JGBM;
                ...
                foreach (KhsDzbModel v in ls) {
                    ...
                    if (m == null) continue;
                    html += "<tr>";
                    html += "<td align='center'><a href='KhbzEdit.aspx?Id=" + m.ID + "'>" + v.ZBMC + "</a></td><td align='center'>" + Enterprise.Service.Perfo.Sys.SysBmjgService.GetBmjgName(v.FZBM.ToInt()) + "</td><td align='center'>" + khdzbSrv .GetStatus(m)+ "</td>";
                    html += "</tr>";
                }
                html += "</table>";
