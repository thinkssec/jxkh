<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KhZbLr.aspx.cs" Inherits="Enterprise.UI.Web.Module.KhX.KhZbLr" %>
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            $("#btnBack").bind("click", function ()
            {
                ...
                location.href = "/Module/Kh/<%=string.IsNullOrEmpty(back)?"KhbzEdit":back%>.aspx?Id=<%=khdzbid%>&bm=<%=bm%>&khid=<%=khid%>";
            });
        });
        /**
       * 评分方式下拉框是否绑定选择改变事件
...
<body>
    <form id="form1" runat="server">
        <div id="p" class="easyui-panel" title="考核指标" icon="icon-save" collapsible="true" style="padding: 10px; background: #fafafa;">
            打分方式：<select id="selectType" class="easyui-combobox" style="width: 150px;cursor:pointer;" editable="false">
                <option value="xm1">按照考核项目1打分</option>
                <option value="xm2">按照考核项目2打分</option>
                <option value="nr">按照考核内容打分</option>
            </select>
            继承模板：<input id="selectMbList" editable="false" style="width: 300px;" />
