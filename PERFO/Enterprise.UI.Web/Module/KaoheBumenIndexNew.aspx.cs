...
namespace Enterprise.UI.Web.Module
{
    ...
    public partial class KaoheBumenIndexNew : PageBase
    {
        ...
        private void InitData()
        {
            ...
            KaoheLst = khglSrv.GetList().Where(p=>p.KHZT=="2").ToList();
        ...
        protected string GetEjdwKaoheInfo()
        {
            ...
            {
                khInfo = (string)CacheHelper.GetCache(khglSrv.CacheKey + "_GetEjdwKaoheInfo_" + userModel.JGBM);
            }
            ...
            {
                //数据存入缓存系统
                CacheHelper.Add(khglSrv.CacheKey + "_GetEjdwKaoheInfo_" + userModel.JGBM, khInfo);
            }
            return khInfo;
        }
